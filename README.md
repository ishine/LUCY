...
<p align="center">
    <img src="https://github.com/VITA-MLLM/LUCY/blob/main/assets/images/icon.png" width="40%" height="20%">
</p>
...
<p align="center">
    ...
    <img src="https://img.shields.io/badge/%F0%9F%A4%97%20Hugging%20Face-Demo-ffc107?color=ffc107&logoColor=white" /></a>
 </p>
...
- You can also align audio encoder yourself using *s1.sh* or align a **Whisper** encoder using *s1whisper.sh*.
    ```
    bash run_scripts/s1.sh
    bash run_scripts/s1whisper.sh
    ```
#### Stage 2 & 3 
